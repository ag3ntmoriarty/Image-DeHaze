...
from utils import unsup_wiener_channel
...
parser.add_argument('--model', default='MixDehazeNet_b', type=str, help='model name')
...
parser.add_argument('--gpu', default='2,3', type=str, help='GPUs used for training')
parser.add_argument('--wiener_filter', default='False', type=bool, help='for weiner filter during training')
...
def train(train_loader, network, criterion, optimizer, scaler):
	...
	for batch in train_loader:
		...
		if args.wiener_filter:
			input_img = unsup_wiener_channel(source_img.cpu())
...
if __name__ == '__main__':
	...
	checkpoint=torch.load('./saved_models/indoor/'+args.model+'wo_CR_2.pth')
